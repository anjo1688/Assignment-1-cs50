...
local pause = love.graphics.newImage('pausa.png')
...
function love.draw()
	if pausa then
      ...
      love.graphics.printf('Press P to continue the game', VIRTUAL_WIDTH/2 - 125, VIRTUAL_HEIGHT/2 - 50, VIRTUAL_WIDTH/2, 'center')
